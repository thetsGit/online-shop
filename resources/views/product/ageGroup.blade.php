      ...
      <div class="row">
          ...
          <div class="position-sticky" style="top: 5rem">
            ...
            <ul class="list-group-flush m-0 p-0">
              ...
              @if ($c->product_count>0)
                @if ($requestedCategory && $requestedCategory->name === $c->name)
                <a href="{{url("/products/ageGroup/$ageGroup->slug"."?"."category=".$c->slug."#product-section")}}" class="list-group-item active bg-primary d-flex justify-content-between align-items-center" style="border-color: #2ba9cd;!important">
                    <span>{{$c->name}}</span>
                </a>
               @else
                <a href="{{url("/products/ageGroup/$ageGroup->slug"."?"."category=".$c->slug."#product-section")}}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                    <span>{{$c->name}}</span>
                    <span class="badge bg-danger">{{$c->product_count}}</span>
                </a>
               @endif
              @endif
              @endforeach
        ...
        <div class="col-12 col-md-9 col-lg-10 py-5">
         <div class="row" id="product-section">
            ...
            <h3 class="mb-3 fs-4 fw-bold text-left text-capitalize">products for {{$ageGroup->name}}</h3>
